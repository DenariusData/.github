...
| **2º SEM** | [DenariusData](https://github.com/DenariusData/API-2SEM) | — | Sistema de Avaliação PACER que simplifica uma avaliação e garante a integração dos dados coletados. | — |
...
| **5º SEM** | [Nexus](https://github.com/DenariusData/API-5SEM) | [SIATT](https://www.siatt.com.br/?lang=pt) | Plataforma analítica para integração e análise de dados estratégicos de projetos, consolidando informações de custos de materiais, horas de trabalho e histórico operacional para apoiar a tomada de decisão. | Frontend: <a href="https://github.com/DenariusData/API-5SEM-FRONTEND">Frontend</a> <br> Backend: <a href="https://github.com/DenariusData/API-5SEM-BACKEND">Backend</a> |
| **6º SEM** | [AkaVision ](https://github.com/DenariusData/API-6SEM) | [AKAER](https://www.akaer.com.br/) | Classificador de Documentos Técnicos. | Frontend: <a href="https://github.com/DenariusData/API-6SEM-FRONTEND">Frontend</a> <br> Backend: <a href="https://github.com/DenariusData/API-6SEM-BACKEND">Backend</a> |
...
| **Scrum Master** | Tiago Bernardo | [![Linkedin](https://img.shields.io/badge/Linkedin-blue?logo=Linkedin&logoColor=white)](https://www.linkedin.com/in/tiagobernardosantos/) [![GitHub](https://img.shields.io/badge/GitHub-111217?logo=github&logoColor=white)](https://github.com/TiagoBernardoSantos) |
...
| **Dev Team** | Aline Ramos | [![Linkedin](https://img.shields.io/badge/Linkedin-blue?logo=Linkedin&logoColor=white)](https://www.linkedin.com/in/aline-ramos-3186b130/) [![GitHub](https://img.shields.io/badge/GitHub-111217?logo=github&logoColor=white)](https://github.com/allineramos)  |
